...
| `0017` | [Two teams](0017-two-teams.md) | implemented | Two teams, chosen once and for good; matches oppose both teams (strictly 2 sides); team score = individual points sum + clash points |
| `0018` | [Scarf theft](0018-scarf-theft.md) | implemented | Scarf theft (« vol de foulard »): admin assigns thefts to players with configurable points (default 2), tracked in player score and admin log |
