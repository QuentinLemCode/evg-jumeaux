...
/**
 * Who captains which team (spec 0017, rule 6). The end-to-end roster has
...
async function seed(): Promise<void> {
  ...
  // this roster keeps a null captain and works exactly as well (rule 6).
  for (const team of teamRows) {
    ...
    // A captain is seeded onto their own team and never chooses (rule 7).
